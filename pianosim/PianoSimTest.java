...
public class PianoSimTest {
    ...
    public static void main(String[] args) throws Exception {
        File file1 = new File("D:\\Documents\\NetBeansProjects\\BasicGraphics\\src\\basicgraphics\\sounds\\C1.wav");
        Clip clip = AudioSystem.getClip();
        AudioInputStream ais = AudioSystem.
            getAudioInputStream( file1);
        clip.open(ais);

        File file2 = new File("D:\\Documents\\NetBeansProjects\\BasicGraphics\\src\\basicgraphics\\sounds\\E1.wav");
        Clip clip2 = AudioSystem.getClip();
        AudioInputStream ais2 = AudioSystem.
            getAudioInputStream( file2);
        clip2.open(ais2);
        
        File file3 = new File("D:\\Documents\\NetBeansProjects\\BasicGraphics\\src\\basicgraphics\\sounds\\G1.wav");
